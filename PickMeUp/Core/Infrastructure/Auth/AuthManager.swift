...
final class AuthService {
    ...
    func validateSession() async -> Bool {
        guard KeychainManager.shared.load(key: KeychainType.refreshToken.rawValue) != nil else {
        ...
        do {
            ...
            if let success = response.success {
                ...
                KeychainManager.shared.save(key: KeychainType.accessToken.rawValue, value: success.accessToken)
                KeychainManager.shared.save(key: KeychainType.refreshToken.rawValue, value: success.refreshToken)
                return true
            } else {
